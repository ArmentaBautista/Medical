...
/****** Object:  Database [MedicalDb]    Script Date: 04/01/2025 06:46:17 p. m. ******/
CREATE DATABASE [MedicalDb]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'MedicalDb', FILENAME = N'/var/opt/mssql/data/MedicalDb.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'MedicalDb_log', FILENAME = N'/var/opt/mssql/data/MedicalDb_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [MedicalDb] SET  ENABLE_BROKER 
GO
...
ALTER DATABASE [MedicalDb] SET RECOVERY FULL 
GO
